...
export class MatrixAdapter implements ChannelAdapter {
	...
	async start(): Promise<void> {
		...
		// Suppress M_NOT_FOUND errors from MatrixHttpClient during E2EE operations
		// These occur when the SDK tries to fetch encryption keys that don't exist,
		// typically when E2EE is enabled in lettabot but not in the Matrix room.
		// See docs/matrix-setup.md for troubleshooting E2EE issues.
